...
/* Type Text*/	
    ...
    if ($("#personal").length) {
        ...
        personal.typeString('Software Engineer').pauseFor(2000).deleteAll()
            .typeString('.NET Full Stack Developer').pauseFor(2000).deleteAll()
            .typeString('Blockchain Developer').start();
    }
